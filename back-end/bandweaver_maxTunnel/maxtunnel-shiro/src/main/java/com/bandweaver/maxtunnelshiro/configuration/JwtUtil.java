...
public class JwtUtil {
    ...
    public static String getUserNameFromToken(String token) {
        Object username = getClaimsFromToken(token).get("username");
    ...
    public static String getPrivateClaimsFromToken(String token, String key) {
            Object privateClaim = getClaimsFromToken(token).get(key);
            return privateClaim == null ? null : privateClaim.toString();
    }
